...
class EstatePropertyOffer(models.Model):
    ...
    '''' Displaying currency '''
    currency_id = fields.Many2one(related='offer_property_id.currency_id', string="Currency")
    ...
    def action_accept(self):
        for rec in self:
            ...
            if accepted_offers:
                ...
                property_id = rec.offer_property_id.property_id
                if property_id:
                    property_id.write({'state': 'offer_accepted'})
    ...
    def check_offer_price(self):
        for rec in self:
            if rec.price < 0:
                raise ValidationError(_("Warning....\n Offered Price should be Positive!"))
