...
class TenantPayment(models.Model):
    ...
    monthly_rent = fields.Float(string="Monthly Rent", related='contract_id.selling_price', store=True, readonly=True)
    ...
    tenant_attachments = fields.Many2many('ir.attachment', string='Attachment File',
