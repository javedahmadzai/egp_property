...
class RealEstate(models.Model):
    ...
    deed_number = fields.Text(string="Deed Number")
    ...
    def get_property_area_type_label(self):
        label_mapping = {
            'ground': 'Ground',
            'building': 'Building',
            'fort': 'Fort Qala',
        }
        return label_mapping.get(self.property_area_type, '')
    ...
    ], default='government', string="Tag", tracking=True)
    ...
    def get_tag_label(self):
        ...
        return label_mapping.get(self.tag_id, '')
    ...
    def get_grade_type_property_label(self):
        label_mapping = {
            'first_grade': 'First Grade',
            'second_grade': 'Second Grade',
            'third_grade': 'Third Grade',
        }
        return label_mapping.get(self.grade_type_property, '')
